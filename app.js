// project started on 7 August 2018... 
// a clone of school portal
...
mongoose.connect("mongodb://localhost:27017/coachingPortal", (err) => {
    if (err) {
        console.log(err);
    }
    else {
...
app.get("/students/timetable",(req,res)=>{
